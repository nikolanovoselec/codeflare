...
export const EXECUTION = {
  ...
  software: {
    ...
    context: [
      ...
      { tone: 'agent', text: 'clone complete · develop checked out · graph current' },
      {
        tone: 'cmd',
        intent: 'request',
      ...
      { tone: 'cmd', intent: 'approval', text: 'Execute the plan.' },
      { tone: 'ok', text: 'implementation complete · TDD suite green · worktree ready' },
    ...
    events: [
      { tone: 'cmd', intent: 'approval', text: 'Fix it and rerun review.' },
      ...
      { tone: 'ok', text: 'PR #84 opened · required checks green · ready to merge' },
      {
        tone: 'cmd',
        intent: 'approval',
        text: 'Approve, update the PR body, and squash-merge to main.',
      },
      { tone: 'ok', text: 'PR #84 squash-merged · main updated · PR closed' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 'Reset develop to origin/main and force-push.',
      },
      { tone: 'ok', text: 'develop aligned with origin/main · worktree clean' },
    ],
  ...
  infrastructure: {
    ...
    events: [
      { tone: 'cmd', intent: 'approval', text: 'Approved. Run check mode first, then execute.' },
      ...
      { tone: 'info', text: 'config valid · local health 200 · restart gate clear' },
      { tone: 'cmd', intent: 'approval', text: 'Restart nginx. Roll back if checks fail.' },
