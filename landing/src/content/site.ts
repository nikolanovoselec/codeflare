...
export const EXECUTION = {
    ...
    context: [
      {
        tone: 'cmd',
        intent: 'request',
        text: 't.anderson@metacortex.ai $ gh repo clone nikolanovoselec/codeflare-inference-mesh',
      },
      { tone: 'agent', text: '✻ repository cloned · develop clean · graph current · ready' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 't.anderson@metacortex.ai $ pi "Plan Inference Mesh routing. Do not edit."',
      },
      { tone: 'agent', text: '✻ planning mode · 6 tasks · requirements linked · routing and fallback tests identified' },
      {
        tone: 'cmd',
        intent: 'approval',
      ...
      { tone: 'ok', text: '✓ implementation complete · routing and fallback tests pass · worktree ready' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 'Run code-reviewer on the exact diff, then doc-updater and spec-reviewer against its findings.',
      },
      { tone: 'warn', text: '⚠ code-reviewer: fallback assertion missing · doc-updater aligned · spec-reviewer clean' },
    ],
    events: [
      {
        tone: 'cmd',
      ...
      { tone: 'ok', text: '✓ code-reviewer · doc-updater · spec-reviewer all clean · reviewed head pushed' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 'Open the pull request from this reviewed head. Require exact-head CI before merge.',
      },
      { tone: 'ok', text: '✓ PR #84 opened from reviewed head · exact-head CI green · approval recorded' },
      {
        tone: 'cmd',
        intent: 'approval',
        text: 'Approved. Merge PR #84 only from that exact head and retain review and CI receipts.',
      },
      { tone: 'ok', text: '✓ merged into main · reviewed head confirmed · review and CI evidence retained' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 'Realign develop with origin/main, confirm the clean worktree, and retain branch evidence.',
      },
      { tone: 'ok', text: '✓ develop aligned with origin/main · worktree clean · exact-head evidence retained' },
    ],
  ...
  infrastructure: {
    ...
    context: [
      {
        tone: 'cmd',
        intent: 'request',
        text: "t.anderson@metacortex.ai $ ssh prod-web-07 'uptime; coredumpctl list nginx --no-pager'",
      },
      ...
      { tone: 'info', text: 'check mode · nginx recovery on prod-web-07 · 2 package changes · no restart' },
      {
        tone: 'cmd',
        intent: 'request',
    ...
    events: [
      ...
      { tone: 'info', text: 'nginx -t syntax-ok · active_upstream_workers_return_200' },
      {
        tone: 'cmd',
        intent: 'approval',
      ...
      { tone: 'ok', text: '✓ nginx 1.26.3 restarted · config valid · workers healthy · rollback unused' },
      {
        tone: 'cmd',
        intent: 'request',
        text: 'Verify local health and nginx errors, retain evidence, then close INC-4821 if checks pass.',
      },
      { tone: 'ok', text: '✓ health 200 in 0.018s · no new errors · change evidence retained · INC-4821 closed' },
    ],
