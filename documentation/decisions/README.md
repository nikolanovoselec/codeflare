...
- Capture retry impact: a stopped capture leaves the old counter intact and retries after the stale pending marker clears instead of skipping the 15-prompt window.
