...
| [AD157](#ad157-reset-stale-stopping-ownership-on-owner-status-reads) | Reset stale stopping ownership on owner status reads | Historical timeout policy; superseded for future sessions because time cannot prove process exit. | Architecture, Storage, Reliability | Superseded |
