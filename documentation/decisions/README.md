...
| [AD103](#ad103-pi-extraction-agents-use-bounded-medium-reasoning-and-one-pass-inputs) | Bound Pi extraction to medium reasoning and one-pass inputs | Pi memory and Vault workers receive frozen inputs, Bash-only tools, medium reasoning, and seven turns, bounding cost while allowing larger prompt-cadenced inputs to page safely. | Agents, Memory, Performance | Active |
