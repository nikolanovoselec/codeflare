...
| ~~[AD107](#ad107-context-mode-is-opt-in-in-pi-pending-upstream-memory-safety)~~ | ~~Keep context-mode opt-in for Pi sessions~~ | [AD140](#ad140-pi-starts-context-mode-off-and-exposes-optional-tool-schemas-on-demand) restores opt-in startup while retaining the managed single-owner adapter after explicit enablement. | Agents, Architecture, Reliability | Superseded |
...
**Related REQs:** [REQ-AGENT-076](../../sdd/spec/agents.md#req-agent-076-pi-context-mode-enablement-and-tool-extension-defaults), [REQ-AGENT-156](../../sdd/spec/agents.md#req-agent-156-bounded-lossless-pi-prompt), and [REQ-AGENT-158](../../sdd/spec/agents.md#req-agent-158-bounded-initial-pi-tool-exposure).
