...
| [AD129](#ad129-proxied-inline-uri-identity-must-be-observed-before-lifecycle-changes) | Proxied Inline URI identity must be observed before lifecycle changes | Architecture, Operations |
...
**Status:** Accepted (2026-08-16); evidence gate satisfied by the integration probe recorded in [AD130](#ad130-the-projected-workspace-uses-the-canonical-browser-authority). Adds an evidence gate to [AD128](#ad128-inline-review-lifecycle-belongs-to-the-pinned-controller) without changing its review ownership. Implements [REQ-IDE-034](../../sdd/spec/browser-ide.md#req-ide-034-bounded-inline-lifecycle-diagnostics).
...
**Status:** Accepted (2026-08-16). Implements [REQ-IDE-015](../../sdd/spec/browser-ide.md#req-ide-015-fixed-workspace-projection-and-clean-browser-ide-url) AC5 and preserves [AD128](#ad128-inline-review-lifecycle-belongs-to-the-pinned-controller).
