...
**Status:** Accepted (2026-08-16). Implements [REQ-IDE-015](../../sdd/spec/browser-ide.md#req-ide-015-fixed-workspace-projection-and-clean-browser-ide-url) AC8 and preserves [AD128](#ad128-inline-review-lifecycle-belongs-to-the-pinned-controller).
