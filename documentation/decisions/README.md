...
- Slightly less is audited by the customer's Gateway than AD85's original "all egress" framing; this is the accepted trade-off (platform backends carry codeflare-managed creds and have their own audit).
