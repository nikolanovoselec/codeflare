...
**Related:** [REQ-ENTERPRISE-020](../../sdd/spec/enterprise-mode.md#req-enterprise-020-governed-mode-re-encrypt-migration-engine), [AD89](#ad89-governed-mode-deployment-wide-r2-sse-c-disable-via-a-kv-toggle-with-lossless-in-place-re-encrypt-migration), [Deployment lane](../lanes/deployment.md#governed-mode-migration-batch-status-driven), [Configuration lane](../lanes/configuration.md), [Storage & Sync lane](../lanes/storage-and-sync.md), [Security lane](../lanes/security.md).
