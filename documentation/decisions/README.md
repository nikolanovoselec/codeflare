...
**2026-08-16 privacy amendment:** After the exact-URI probe satisfied the evidence gate and exposed the authority mismatch, diagnostic revision v2 narrowed retained identity to scheme, authority without userinfo, basename, and stable input type. It excludes directory paths, query, fragment, tab labels, and document content. This changes retained support data only; the original probe and its evidence remain historical facts. <!-- @impl: openvscode/agent-sidebar/src/extension.ts::describeUri --> <!-- @impl: openvscode/agent-sidebar/src/extension.ts::describeTab --> <!-- @test: openvscode/agent-sidebar/test/activation.test.ts (REQ-IDE-020 + REQ-IDE-026 + REQ-IDE-029 + REQ-IDE-033 + REQ-IDE-034: inline edits stay bound to the invoking host document) -->
