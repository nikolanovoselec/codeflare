...
**Consequences:** Reopening the dashboard releases stale lifecycle ownership without a container probe, retry worker, cron, lease, or schema change. Recent stops, other states, and other owners remain unchanged. If an old workload survives past the bound, D1 may permit managed reconciliation or a later Start while it still exists; the owner-selected bound accepts that residual risk.
