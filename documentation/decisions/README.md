...
| [AD145](#ad145-herdr-owns-topology-inside-one-codeflare-terminal-surface) | Give in-session terminal topology to Herdr | Each Terminal session keeps one Codeflare surface while an ephemeral Herdr runtime owns inner topology; MultiView remains cross-session state. | Architecture, Build / Container, Terminal | Active |
---
