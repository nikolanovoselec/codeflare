...
The live handler also records that each recognized boundary was evaluated, including ineligible no-plan outcomes. After reload, settled enforcement reconstructs only a persisted successful boundary lacking both that evaluation marker and a correlated launch plan, then emits its initial plan once.
