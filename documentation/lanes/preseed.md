...
8. The Worker scans at most ten 100-record release-history pages from newest to oldest and activates the first valid release whose hash equals that deployment's build hash. Newer releases for other builds are skipped, not treated as failures. <!-- @impl: src/lib/remote-curation.ts::resolveManagedEnvironmentRelease -->
