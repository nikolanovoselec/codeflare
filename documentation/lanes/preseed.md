...
The managed advanced design family uses `design` as a compact router across work mode, purpose, platform, and available direction. `frontend-design`, `native-mobile-design`, `desktop-native-design`, and `canvas-design` own web, mobile, desktop, and static art direction respectively. Routing permits exactly one authority per deliverable; `frontend-components`, `frontend-patterns`, `motion-design`, and Impeccable remain bounded engineering or finishing support. `design-taste-frontend` is a compatibility redirect. The unsafe UI UX Pro Max preset corpus and `emil-design-eng` monolith are absent from managed distribution. ([REQ-AGENT-179](../../sdd/spec/agents.md#req-agent-179-portable-visual-design-routing), [REQ-AGENT-180](../../sdd/spec/agents.md#req-agent-180-portable-frontend-design-authority), [REQ-AGENT-181](../../sdd/spec/agents.md#req-agent-181-design-specialist-compatibility), [REQ-AGENT-182](../../sdd/spec/agents.md#req-agent-182-purpose-and-platform-design-routing), [REQ-AGENT-183](../../sdd/spec/agents.md#req-agent-183-native-mobile-design-authority))
...
Managed design uses `design` as the lazy router and `frontend-design` as the web art-direction authority. Focused references disclose intake, new work, redesign, art direction, operational information design, components, assets, motion, and visual QA only when needed. Mobile, desktop, and static work have separate owners. `design-taste-frontend` redirects legacy callers; `motion-design` replaces the Emil monolith. Impeccable remains Claude + Pi only with explicit commands intact and a narrowed audit/finishing boundary. ([REQ-AGENT-134](../../sdd/spec/agents.md#req-agent-134-managed-design-skill-suite), [REQ-AGENT-179](../../sdd/spec/agents.md#req-agent-179-portable-visual-design-routing), [REQ-AGENT-180](../../sdd/spec/agents.md#req-agent-180-portable-frontend-design-authority), [REQ-AGENT-181](../../sdd/spec/agents.md#req-agent-181-design-specialist-compatibility))
