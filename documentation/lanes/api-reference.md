...
| POST | `/api/github/clone` | Session cookie | [REQ-GITHUB-004](../../sdd/spec/github.md#req-github-004-clone-a-repository-into-a-session), [REQ-GITHUB-015](../../sdd/spec/github.md#req-github-015-workspace-repository-tracking), [REQ-GITHUB-016](../../sdd/spec/github.md#req-github-016-tracked-repository-restoration) | Clone `{repo, ref?, sessionId}` into a running session. Outcomes include `200`, `403 GITHUB_DISABLED`, `404 SESSION_NOT_FOUND`, `409 CLONE_TARGET_EXISTS`, `502 CLONE_FAILED`, `503 NOT_RUNNING`, or `504`. A `200` persists the repository for resume (rate-limited 20/min) |
