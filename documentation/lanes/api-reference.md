...
| POST | `/api/github/clone` | Session cookie | [REQ-GITHUB-004](../../sdd/spec/github.md#req-github-004-clone-a-repository-into-a-session), [REQ-GITHUB-015](../../sdd/spec/github.md#req-github-015-workspace-repository-tracking), [REQ-GITHUB-016](../../sdd/spec/github.md#req-github-016-tracked-repository-restoration) | Clone into a running session; returns `200`, `409 CLONE_TARGET_EXISTS`, `502 CLONE_FAILED`, or `504`; returns `404 SESSION_NOT_FOUND` when the record is absent and `503 NOT_RUNNING` when asleep. A `200` persists the repository for resume (rate-limited 20/min) |
