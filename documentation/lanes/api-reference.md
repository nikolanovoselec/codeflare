...
| POST | `/api/storage/seed/agent-configs/upgrade` | Session cookie | [REQ-STOR-033](../../sdd/spec/storage.md#req-stor-033-delta-and-resumable-managed-release-reconciliation), [REQ-AGENT-049](../../sdd/spec/agents.md#req-agent-049-auto-upgrade-preseed-on-release) | Dashboard-owned automatic reconcile; managed releases use a direct delta or marker-resumable full target, while baked upgrades keep their existing reconcile behavior |
