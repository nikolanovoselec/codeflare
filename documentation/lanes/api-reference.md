...
| POST | `/operator-webhook/v1/activities/claims/boundary` | Signed protected Action OIDC bearer and bounded JSON claim | [REQ-OPERATOR-053](../../sdd/spec/operator-registry.md#req-operator-053-enterprise-pr-boundary-review-handoff) | Claim the exact prepared Action start handoff once. |
...
### Protected Action boundary claim [REQ-OPERATOR-053](../../sdd/spec/operator-registry.md#req-operator-053-enterprise-pr-boundary-review-handoff) <!-- @impl: src/routes/operator-webhook.ts::app --> <!-- @impl: src/operators/review-boundary-claim.ts::claimVerifiedBoundaryAction -->
