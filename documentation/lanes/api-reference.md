...
| GET, POST | `/api/admin/reasoning/catalog` | Admin role | [REQ-ENTERPRISE-031](../../sdd/spec/enterprise-mode.md#req-enterprise-031-enterprise-pi-capability-profile-administration), [REQ-ENTERPRISE-047](../../sdd/spec/enterprise-mode.md#req-enterprise-047-native-ai-gateway-provider-discovery-and-selection) | Return built-in and custom profiles, compatibility notices, assignment usage, Dynamic Route names, and sanitized gateway-scoped provider presence. Dynamic Route and provider discovery report independent readiness. POST accepts a transient `gateway` overlay. |
| POST | `/api/admin/reasoning/native/profile-discovery` | Admin role, rate limited | [REQ-ENTERPRISE-047](../../sdd/spec/enterprise-mode.md#req-enterprise-047-native-ai-gateway-provider-discovery-and-selection), [REQ-ENTERPRISE-048](../../sdd/spec/enterprise-mode.md#req-enterprise-048-native-provider-capability-catalog) | Assess one configured native/custom provider model through bounded direct-compat probes. Returns exact matching profile revisions or a bounded custom-profile draft only from unambiguous compatible evidence. |
| POST | `/api/admin/reasoning/native/discover` | Admin role, rate limited | [REQ-ENTERPRISE-051](../../sdd/spec/enterprise-mode.md#req-enterprise-051-native-ai-gateway-provider-and-model-workspace), [REQ-ENTERPRISE-052](../../sdd/spec/enterprise-mode.md#req-enterprise-052-native-provider-verification-and-runtime-enforcement), [REQ-ENTERPRISE-053](../../sdd/spec/enterprise-mode.md#req-enterprise-053-native-target-identity-and-document), [REQ-ENTERPRISE-054](../../sdd/spec/enterprise-mode.md#req-enterprise-054-native-target-profile-and-lifecycle-administration), [REQ-ENTERPRISE-055](../../sdd/spec/enterprise-mode.md#req-enterprise-055-native-target-authority-and-save) | Verify one exact native/custom provider target and selected immutable profile revision through bounded compat tool-call and replay, or record explicit administrator confirmation. Returns a short-lived exact-identity Save receipt and no raw provider authority. |
