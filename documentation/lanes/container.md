...
Copilot 1.0.86 sandbox prerequisites include `slirp4netns`, `iptables`/`ip6tables` and util-linux. Installing them does not grant TUN access, privileged containers or local-network permission; platform restrictions and explicit sandbox policy still apply.
