...
Explicit Herdr copy uses bounded OSC 52 browser writes. If Samsung rejects a write, the latest failure remains available to the next trusted Paste action, which retries the browser write and pastes through xterm ([REQ-TERM-032](../../sdd/spec/terminal.md#req-term-032-herdr-clipboard-compatibility-boundary)). Pi and Herdr toasts confirm OSC 52 emission, not browser acceptance. <!-- @impl: web-ui/src/hooks/useTerminal.ts::useTerminal --> <!-- @impl: web-ui/src/lib/osc52.ts::beginClipboardWrite --> <!-- @impl: web-ui/src/components/FloatingTerminalButtons.tsx::pasteFromClipboard -->
