...
Mapping and verification show progress beside the active route, without a duplicate bottom status. After mapping ends, another profile can be selected without refreshing.
