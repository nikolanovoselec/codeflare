...
Connection, Routes, Native providers, and Access & fallback are separate sections. Routes start as a compact status overview; expanding one shows its detected models, Pi compatibility profile, context window, Discover Profile, optional Verify Profile, and Mark as verified.
