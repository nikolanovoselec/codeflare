...
Mapping and verification show progress beside the active route, without a duplicate bottom status. After mapping ends, another profile can be selected without refreshing. ([REQ-ENTERPRISE-041](../../sdd/spec/enterprise-mode.md#req-enterprise-041-enterprise-pi-administrator-workspace))
