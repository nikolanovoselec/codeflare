...
Custom profiles are immutable revisions created by discovery rather than by asking administrators to author request paths and scalar mappings. The administrator chooses an auto-discovered Dynamic Route, starts the bounded Pi 0.84.4 streaming/tool/replay discovery using the already-saved Worker-side AI Gateway connection, reviews the sanitized unambiguous match, and supplies a profile name. Adding the generated revision to the draft does not assign or activate it.

Incomplete, stale, heterogeneous, unsupported, inconclusive, or ambiguous evidence produces no generated revision; existing enabled profiles remain available for explicit warned testing during Review. Preview and Apply use the same configuration revision; Apply recomputes required warnings and rejects stale revisions. Custom revisions and assignments are validated together and written as one `setup:reasoning_configuration` document. ([REQ-ENTERPRISE-031](../../sdd/spec/enterprise-mode.md#req-enterprise-031-enterprise-pi-capability-profile-administration), [REQ-ENTERPRISE-032](../../sdd/spec/enterprise-mode.md#req-enterprise-032-enterprise-pi-route-selection-and-runtime-translation), [REQ-ENTERPRISE-034](../../sdd/spec/enterprise-mode.md#req-enterprise-034-enterprise-pi-administration-workflow)) <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields --> <!-- @impl: src/lib/admin-configuration.ts::buildConfigurationPreview -->
