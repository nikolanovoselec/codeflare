...
| Protected Action | nullable `boundary_activity_id TEXT`; retains the exact pending activity until terminal result consumption or durable Stop cancellation |
