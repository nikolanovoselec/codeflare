...
This lane owns the D1-backed session catalog and lifecycle projection. It does not own credentials, provider tokens, preferences, entitlement policy, or production cutover execution.
