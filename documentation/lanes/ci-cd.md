...
- **backend-tests** — six Workers jobs use exact-head duration plus per-file overhead for longest-first assignment; Node runs separately. New files receive maximum recorded weight. <!-- @impl: scripts/ci/select-weighted-backend-tests.mjs::assignWeightedFiles --> <!-- @impl: scripts/ci/backend-test-weights.json -->
