...
7. Scan with Trivy (HIGH/CRITICAL severity, `ignore-unfixed: true`; `.trivyignore` for fixable CVEs consciously accepted — see [Security §Container Image Scanning](security.md#container-image-scanning))
