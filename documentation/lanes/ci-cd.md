...
- **browser-ide-image:** builds the image without pushing and validates the immutable Pi/Claude/empty extension inventories against the packaged-boundary contract ([REQ-IDE-010](../../sdd/spec/browser-ide.md#req-ide-010-pinned-ide-inventory-compatibility)).
