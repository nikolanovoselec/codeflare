...
- **browser-ide-image:** builds without pushing; verifies inventories, no VSIX, ownership, ABI 127, host-compatible view registration and CSP resolution, Claude controls, and lazy startup; then records image size, idle process count, and RSS.
