...
| `promotion-source.yml` | PRs to `main` or `master` | Publishes the required `Develop promotion source` status and fails unless the PR head branch is exactly `develop` ([REQ-OPS-036](../../sdd/spec/operations.md#req-ops-036-develop-only-main-promotion)). |
