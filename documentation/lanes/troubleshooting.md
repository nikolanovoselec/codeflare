...
Normal **Discover** selects and verifies one shared contract; review its grade, assign access and Save. A failed minimum cannot be bypassed with administrator confirmation. See [Target capability discovery](target-capability-discovery.md#evidence-and-qualification) and [REQ-ENTERPRISE-035](../../sdd/spec/enterprise-mode.md#req-enterprise-035-enterprise-pi-protocol-match-selection). The instructions below apply to retained **Advanced** workflows, not normal Discover. <!-- @impl: src/lib/ai-capability-discovery/index.ts::discoverTargetCapabilities --> <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields -->
