...
**Requirements (continued):** [REQ-IDE-030](../../sdd/spec/browser-ide.md#req-ide-030-native-inline-chat-result-envelope), [REQ-IDE-033](../../sdd/spec/browser-ide.md#req-ide-033-controller-owned-inline-review-lifecycle), [REQ-IDE-034](../../sdd/spec/browser-ide.md#req-ide-034-bounded-inline-lifecycle-diagnostics), [REQ-IDE-035](../../sdd/spec/browser-ide.md#req-ide-035-canonical-browser-ide-workspace-projection), [REQ-IDE-036](../../sdd/spec/browser-ide.md#req-ide-036-persistent-user-managed-extensions), [REQ-IDE-037](../../sdd/spec/browser-ide.md#req-ide-037-lazy-extension-restoration), [REQ-IDE-038](../../sdd/spec/browser-ide.md#req-ide-038-extension-warning-acknowledgement), [REQ-IDE-040](../../sdd/spec/browser-ide.md#req-ide-040-user-extension-allowance-policy), [REQ-IDE-043](../../sdd/spec/browser-ide.md#req-ide-043-native-pi-provider-history-isolation), [REQ-IDE-048](../../sdd/spec/browser-ide.md#req-ide-048-dashboard-owned-vs-code-session-lifecycle), [REQ-IDE-049](../../sdd/spec/browser-ide.md#req-ide-049-dashboard-vs-code-startup-and-recovery), [REQ-IDE-050](../../sdd/spec/browser-ide.md#req-ide-050-browser-ide-status-and-ownership), [REQ-IDE-054](../../sdd/spec/browser-ide.md#req-ide-054-browser-ide-card-activation), [REQ-IDE-055](../../sdd/spec/browser-ide.md#req-ide-055-retained-browser-ide-window-opening), [REQ-IDE-051](../../sdd/spec/browser-ide.md#req-ide-051-default-workspace-preference), [REQ-IDE-052](../../sdd/spec/browser-ide.md#req-ide-052-immutable-session-workspace-snapshot), [REQ-IDE-053](../../sdd/spec/browser-ide.md#req-ide-053-workspace-specific-editor-startup).
...
| Session status and durable fields | Session | Workers KV `session:*` record | Persistent | Lifecycle and authenticated session routes | Dashboard and policy routes | Container lifecycle |
| Session readiness and metrics overlays | Session | Workers KV `session-editor:*` and `session-metrics:*` metadata <!-- @impl: src/lib/kv-keys.ts::putSessionEditorState --> <!-- @impl: src/lib/kv-keys.ts::putSessionMetricsState --> | Session lifetime | Browser IDE routes and Container DO | Dashboard batch-status <!-- @impl: src/routes/session/lifecycle.ts::app --> | Session lifecycle and deletion |
| Live-status correction | Session | Workers KV `session-status-correction:*` metadata <!-- @impl: src/lib/kv-keys.ts::putSessionRunningCorrection --> | Bounded to 120 seconds | Container DO | Dashboard, access guards, limits, sync fan-out <!-- @impl: src/lib/session-helpers.ts::listRunningSessionIds --> | Lifecycle tombstone or TTL |
| Container coordination and recovery evidence | Session | Container DO storage <!-- @impl: src/container/index.ts::container --> | Durable across DO hibernation/reconstruction | Container DO | Container DO | Container lifecycle |
