...
Code, specification, and documentation lanes use the provider-neutral `medium` thinking profile without changing scope or enforcement policy ([REQ-AGENT-087](../../sdd/spec/agents.md#req-agent-087-pi-reviewer-execution-profile)).
