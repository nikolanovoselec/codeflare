...
README media reuses the deployed landing artifacts rather than maintaining screenshot-only product variants ([REQ-LANDING-013](../../sdd/spec/landing.md#req-landing-013-canonical-readme-media-capture)). The Architecture section keeps the Mermaid topology instead of duplicating the removed IDE screenshot; accessibility and publishing acceptance remain owned by [REQ-LANDING-016](../../sdd/spec/landing.md#req-landing-016-readme-media-accessibility-and-composition) and [REQ-LANDING-017](../../sdd/spec/landing.md#req-landing-017-readme-media-publishing-acceptance).
