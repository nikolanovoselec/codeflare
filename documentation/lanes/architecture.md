...
- **Repository list UX** `web-ui/src/components/github/RepoList.tsx` and `web-ui/src/styles/github-panel.css` render no-repos/search-empty states and keep every fetched repo in a breakpoint-capped scroll viewport ([REQ-GITHUB-009](../../sdd/spec/github.md#req-github-009-github-repository-list-viewport-and-empty-states)).
- **Mobile face switching** `web-ui/src/components/Dashboard.tsx::effectiveFace` and `web-ui/src/components/github/GitHubPanel.tsx` swap GitHub/R2 storage faces on mobile, force Storage when GitHub is unavailable, and hide the flip control on desktop ([REQ-GITHUB-010](../../sdd/spec/github.md#req-github-010-mobile-github-and-storage-face-switching)).
