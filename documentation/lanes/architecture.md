...
sequenceDiagram
    ...
    Note over X: Own-account R2 + account-scoped CF API / Browser Rendering<br/>are exempt via isAccountScopedDestination(url, accountId) and egress direct;<br/>other accounts ride the Gateway; WS upgrades proxied verbatim (AD86)
