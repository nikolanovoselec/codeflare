...
| `TAB_CONFIG` | JSON configured-session-command snapshot; only entry `1` selects the initial Herdr agent or TUI and Browser IDE agent inventory | - | no | Worker -> DO; Herdr launcher; Browser IDE setup | [REQ-AGENT-002](../../sdd/spec/agents.md#req-agent-002-agent-selection-at-session-creation), [REQ-AGENT-003](../../sdd/spec/agents.md#req-agent-003-agent-cli-auto-started-in-tab-1), [REQ-TERM-005](../../sdd/spec/terminal.md#req-term-005-herdr-runtime-and-configured-agent-startup) |
