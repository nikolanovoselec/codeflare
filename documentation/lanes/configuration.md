...
| `setup:native_ai_targets` | Enterprise-only versioned native-target document under [REQ-ENTERPRISE-053](../../sdd/spec/enterprise-mode.md#req-enterprise-053-native-target-identity-and-document) and [REQ-ENTERPRISE-055](../../sdd/spec/enterprise-mode.md#req-enterprise-055-native-target-authority-and-save). It stores the exact native/custom provider and model selector, raw provider-config identity and alias, immutable profile reference, enabled state, and verification Worker-side. Browser and container projections use only derived `cf-native-<uuid>` handles and safe labels. | Administration AI Routing → KV (no redeploy) |
...
**Native provider targets:** Under [REQ-ENTERPRISE-047](../../sdd/spec/enterprise-mode.md#req-enterprise-047-native-ai-gateway-provider-discovery-and-selection), [REQ-ENTERPRISE-048](../../sdd/spec/enterprise-mode.md#req-enterprise-048-native-provider-capability-catalog), [REQ-ENTERPRISE-051](../../sdd/spec/enterprise-mode.md#req-enterprise-051-native-ai-gateway-provider-and-model-workspace), [REQ-ENTERPRISE-052](../../sdd/spec/enterprise-mode.md#req-enterprise-052-native-provider-verification-and-runtime-enforcement), [REQ-ENTERPRISE-053](../../sdd/spec/enterprise-mode.md#req-enterprise-053-native-target-identity-and-document), [REQ-ENTERPRISE-054](../../sdd/spec/enterprise-mode.md#req-enterprise-054-native-target-profile-and-lifecycle-administration), and [REQ-ENTERPRISE-055](../../sdd/spec/enterprise-mode.md#req-enterprise-055-native-target-authority-and-save), the Native providers section lists added provider-model targets in the same collapsed disclosure style as Routes. Orange Not ready targets are unavailable to policies; successful verification or administrator confirmation automatically produces green Ready status and policy eligibility. Add and Remove stay at list level; expanding a target exposes provider, model, context, profile, discovery, verification, and confirmation controls. A sole provider binding is selectable; multiple bindings require one unambiguous default. Custom-provider discovery determines the Worker-owned `custom-<slug>` selector. Detection proves presence only.
...
Point-in-time validation on the `codeflare-enterprise` gateway covered Bedrock Claude Sonnet 5 and Opus 5 from the supplied external report; Gemini 3.1 Pro and 3.7/3.8 Flash; OpenAI GPT-5.6 Sol, Terra, and Luna; and Codeflare Inference Mesh `ornith-1-5-9b-gguf-q8-0`. Bedrock, Gemini, and Mesh retain provider-default reasoning. GPT-5.6 uses the only tested Chat Completions tool mapping, `reasoning_effort: none`; GPT-6 Astra remains excluded because its Chat Completions tool canary failed. Gemini's adapter preserves only its bounded opaque thought signature through Pi replay metadata. Bedrock alone receives repeated-tool-name repair.
