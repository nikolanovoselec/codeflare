...
- [REQ-AGENT-059](../../sdd/spec/agents.md#req-agent-059-connect-to-cloudflare-via-oauth) - Cloudflare Connect (OAuth): operator client (setup:cloudflare_oauth_client_*) + per-user token, tier->scope
