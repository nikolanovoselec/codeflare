...
| `setup:native_ai_targets` | Enterprise-only versioned native-target document under [REQ-ENTERPRISE-053](../../sdd/spec/enterprise-mode.md#req-enterprise-053-native-target-identity-and-document) and [REQ-ENTERPRISE-055](../../sdd/spec/enterprise-mode.md#req-enterprise-055-native-target-authority-and-save). It stores the exact native/custom provider and model selector, raw provider-config identity and alias, immutable profile reference, enabled state, and verification Worker-side. Browser and container projections follow [REQ-ENTERPRISE-061](../../sdd/spec/enterprise-mode.md#req-enterprise-061-native-target-administration-projection) and [REQ-ENTERPRISE-058](../../sdd/spec/enterprise-mode.md#req-enterprise-058-native-model-container-publication), using only derived `cf-native-<uuid>` handles and safe labels. | Administration AI Routing → KV (no redeploy) |
