...
| `CODEFLARE_CODING_AGENTS` | Canonical coding-agent set baked into this image; records the validated `CODING_AGENTS` build selection. | all six coding agents | no | Dockerfile ENV | [REQ-OPS-038](../../sdd/spec/operations.md#req-ops-038-build-selected-coding-agent-clis) |
