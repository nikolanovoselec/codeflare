...
| `CONTEXT_MODE_BRIDGE_IDLE_MS` | Disables context-mode bridge-child idle reaping/noisy idle-release notices when `0`; set by entrypoint and reinforced by the preseeded Pi runtime extension | `0` (via entrypoint) | no | entrypoint / `context-mode-runtime.ts` | [REQ-AGENT-005](../../sdd/spec/agents.md#req-agent-005-pro-mode-includes-additional-skills-rules-agents-and-mcp-servers) |
