...
Pi offers all seven thinking choices for provider-default routes; these are client hints, not newly supported backend controls. The Worker still discards overrides, and backend profiles remain unchanged. Native models display their saved names while selection and requests retain opaque IDs. See [REQ-ENTERPRISE-058](../../sdd/spec/enterprise-mode.md#req-enterprise-058-native-model-container-publication) and [REQ-ENTERPRISE-082](../../sdd/spec/enterprise-mode.md#req-enterprise-082-pi-native-model-display).
