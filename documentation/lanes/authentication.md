...
The tier is chosen in the UI before the redirect: on the dashboard panel the **Connect** button opens a popover/bottom-sheet tier dialog, while Guided Setup and Settings present the same Minimal/Recommended/Advanced choice as a dropdown with the selected level's description.
