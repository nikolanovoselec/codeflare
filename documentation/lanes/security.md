...
Image assembly also replaces code-server's semver-compatible root `js-yaml` 4.2.0 with integrity-pinned 4.3.1 while its upstream archive remains vulnerable. <!-- @impl: Dockerfile::JS_YAML_SHA512 --> <!-- @impl: scripts/ci/validate-trivy-result.mjs::validateTrivyResult --> <!-- @test: host/__tests__/trivy-exception-gate.test.js (rejects p7zip RCE findings without a reviewed exception) -->
