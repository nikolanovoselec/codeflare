...
Pi runs through code-server's native Chat participant API, not a custom webview. The extension retains one local compatibility provider for the native participant's model-entry contract; its panel/editor model is selectable, account-free, and unable to generate. GitHub Actions image smoke verifies its packaged registration and fail-closed generation contract under [REQ-IDE-005](../../sdd/spec/browser-ide.md#req-ide-005-selected-native-ide-agent), [REQ-IDE-010](../../sdd/spec/browser-ide.md#req-ide-010-pinned-ide-inventory-compatibility), and [REQ-IDE-019](../../sdd/spec/browser-ide.md#req-ide-019-codeflare-eligibility-in-editor-inline-chat) and [REQ-IDE-020](../../sdd/spec/browser-ide.md#req-ide-020-unrestricted-pi-editor-request-execution). <!-- @impl: openvscode/agent-sidebar/src/extension.ts::HOST_COMPATIBILITY_PROVIDER -->
