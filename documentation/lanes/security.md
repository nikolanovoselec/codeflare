...
CVE-2026-56852 remains narrower than a global ID suppression. Integration deployment run `30612952117` for head `82244a1d117194227c0082b9555f3654f903fbd2` retired the gh occurrence when v2.97.0 stopped emitting it. Lazygit 0.64.0 then moved to patched x/text 0.40.0, retiring the remaining occurrence. Neither tuple is accepted now: any CVE-2026-56852 recurrence in gh, lazygit, or another target fails as an unexpected HIGH/CRITICAL finding. The CVE is not in the global ignore file.
