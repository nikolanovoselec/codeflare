...
**Implements:** [REQ-IDE-005](../../sdd/spec/browser-ide.md#req-ide-005-selected-native-ide-agent), [REQ-IDE-006](../../sdd/spec/browser-ide.md#req-ide-006-ide-conversation-context-and-credential-isolation), [REQ-IDE-007](../../sdd/spec/browser-ide.md#req-ide-007-ide-guarded-approval), [REQ-IDE-008](../../sdd/spec/browser-ide.md#req-ide-008-ide-agent-process-lifecycle), [REQ-IDE-009](../../sdd/spec/browser-ide.md#req-ide-009-frictionless-workspace-open-for-every-ide-agent), [REQ-IDE-010](../../sdd/spec/browser-ide.md#req-ide-010-pinned-ide-inventory-compatibility), [REQ-IDE-011](../../sdd/spec/browser-ide.md#req-ide-011-file-review-with-codeflare), [REQ-IDE-013](../../sdd/spec/browser-ide.md#req-ide-013-account-backed-code-review-suppression), [REQ-IDE-014](../../sdd/spec/browser-ide.md#req-ide-014-active-editor-review-with-codeflare), [REQ-IDE-017](../../sdd/spec/browser-ide.md#req-ide-017-unsupported-ide-inventory-runtime-metadata)
...
Pi runs through code-server's native Chat participant API, not a custom webview. The extension retains one local compatibility provider for the native participant's model-entry contract; its panel/editor model is selectable, account-free, and unable to generate. GitHub Actions image smoke verifies its packaged registration and fail-closed generation contract under [REQ-IDE-005](../../sdd/spec/browser-ide.md#req-ide-005-selected-native-ide-agent), [REQ-IDE-010](../../sdd/spec/browser-ide.md#req-ide-010-pinned-ide-inventory-compatibility), and [REQ-IDE-019](../../sdd/spec/browser-ide.md#req-ide-019-native-pi-in-editor-inline-chat). <!-- @impl: openvscode/agent-sidebar/src/extension.ts::HOST_COMPATIBILITY_PROVIDER -->

Its `copilot` vendor and tool-calling capability are only pinned Code OSS selection/filter metadata; no GitHub provider, authentication, or inference path is used. The visible participant/provider label is **Codeflare** while stable private IDs remain unchanged. On startup the inventory marks generic Chat setup complete, hiding Code OSS's account-backed **Code Review** action without disabling native Chat or **Review with Codeflare**. The participant does not read `request.model`, invoke that model for inference, or access `vscode.authentication`; it calls the fixed local RPC binary directly. <!-- @impl: openvscode/agent-sidebar/src/extension.ts::activate -->
