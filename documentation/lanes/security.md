...
### Browser IDE native agents ([REQ-IDE-005](../../sdd/spec/browser-ide.md#req-ide-005-selected-native-ide-agent), [REQ-IDE-006](../../sdd/spec/browser-ide.md#req-ide-006-ide-conversation-context-and-credential-isolation), [REQ-IDE-007](../../sdd/spec/browser-ide.md#req-ide-007-ide-guarded-approval), [REQ-IDE-008](../../sdd/spec/browser-ide.md#req-ide-008-ide-agent-process-lifecycle), [REQ-IDE-009](../../sdd/spec/browser-ide.md#req-ide-009-frictionless-workspace-open-for-every-ide-agent), [REQ-IDE-010](../../sdd/spec/browser-ide.md#req-ide-010-pinned-ide-inventory-compatibility))
...
**Verification:** [Native context tests](../../openvscode/agent-sidebar/test/native-chat.test.ts), [unrestricted-action tests](../../openvscode/agent-sidebar/test/vscode-approval-host.test.ts), [process-generation tests](../../openvscode/agent-sidebar/test/process-generation.test.ts), [official Claude tests](../../openvscode/claude/test), [host cleanup tests](../../host/__tests__/entrypoint-openvscode.test.js), [packaging identity tests](../../openvscode/agent-sidebar/test/packaging.test.ts), and [complete-image smoke](../../scripts/ci/smoke-openvscode-sidebar-image.mjs) validate the packaged boundary.
...
Editor collection canonicalizes file URIs against `/home/user/workspace`, rejects symbolic-link aliases, escapes, non-file values, and malformed ranges, bounds active content, selection, open files, diagnostics, references, history, and total UTF-8 bytes, and marks the result as untrusted workspace data. Each request gets a fresh no-session process, preventing hidden cross-chat or terminal history. <!-- @impl: openvscode/agent-sidebar/src/pi/native-chat.ts::runNativePiChat -->
