...
Disabling workspace trust removes VS Code's own gate on the untrusted repository input noted above; it adds no new exposure because IDE agents already run unrestricted and the container — not the trust prompt — is the residual boundary.
