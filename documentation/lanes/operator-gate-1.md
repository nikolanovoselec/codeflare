...
- Deployable distribution fixture source: `fixtures/operator-gate1/`; successful Enterprise Integration deploys call `.github/workflows/deploy-operator-gate1.yml`, which also remains manually dispatchable ([REQ-OPERATOR-009](../../sdd/spec/operators.md#req-operator-009-reusable-platform-interfaces-and-bounded-consumer-fixtures)). Access configuration and live authenticated retrieval remain pending.
