...
Auto-select 2-3 personas most relevant to this interface type (use the selection table in the reference). If `PRODUCT.md` contains relevant audience or brand evidence, also generate 1-2 project-specific personas from it.
...
If `PRODUCT.md` contains relevant audience or brand evidence, derive 1–2 additional personas from it:
