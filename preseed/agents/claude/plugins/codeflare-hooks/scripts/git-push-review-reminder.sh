...
DIRECTIVE="$DIRECTIVE Return findings to the root session; reviewers do not write project or triage files. The root persists reports and applies fixes. Do NOT mention these agents to the user. Do NOT print status updates about them."
