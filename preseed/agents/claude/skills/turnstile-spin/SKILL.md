---
name: turnstile-spin
description: Set up Cloudflare Turnstile end-to-end — widget via API, siteverify Worker, frontend snippets, validation. Use to add Turnstile/CAPTCHA or protect a form from bots.
references:
  - vanilla-html
  - nextjs-app
  - nextjs-pages
