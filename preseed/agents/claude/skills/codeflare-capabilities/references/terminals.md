...
While the container and PTY remain alive, I reconnect the browser and restore bounded terminal output. After container replacement, the process itself is gone.
...
I choose the right arrangement with you and preserve the right state. You remain able to see the work, interrupt it, and take over a shell instead of surrendering the whole environment to an opaque background task.
