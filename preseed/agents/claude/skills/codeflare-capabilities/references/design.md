...
I can create a product-specific design direction and carry it into working software or a finished static composition. Codeflare routes the job to the right design authority instead of asking one generic frontend prompt to design a mobile app, an operations console, and a poster with the same bag of tricks.

For responsive web products, I can define information architecture, hierarchy, typography, color, geometry, imagery, interaction, motion, responsive transformation, and component behavior. Native mobile work gets platform-specific navigation, gestures, safe areas, keyboard behavior, lifecycle, accessibility, and interruption handling. Desktop-native work respects windowing, menus, commands, density, and operating-system conventions.
...
> Establish one visual direction for this product, then design the responsive web workflow, its native mobile counterpart, and a print-ready one-page field guide without making them look like three unrelated brands.
