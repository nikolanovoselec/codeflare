...
Status transitions and auto-fix behaviour live in the `spec-enforce` skill. The canonical REQ render shape (numbered ACs `1. 2. 3.`, every labeled field on its own line with blank-line separators) is also there.
