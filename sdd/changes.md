...
## 2026-05-10
- Default container disk increased from 6 GB to 8 GB for all users on the default and saas tiers (REQ-OPS-001). Headroom for npm caches, Docker image extraction, transcript history, and bigger user workspaces; aligns the default tier with what the high tier already provided.
