...
6. The control arms only after two consecutive complete readiness checks; an incomplete check resets that progress. <!-- @impl: src/lib/vault-view.ts::installVaultPrewarmBridgeRuntime --> <!-- @impl: src/lib/vault-view.ts::injectVaultPrewarmBridge --> <!-- @test: src/__tests__/routes/vault-html-direct.test.ts (posts ready only after two consecutive complete polls and resets after incomplete evidence) -->
...
4. The ready bridge reports the canonical scope together with completed runtime, sync, index, required-file, and file-list evidence. <!-- @impl: src/lib/vault-view.ts::installVaultPrewarmBridgeRuntime --> <!-- @impl: src/lib/vault-view.ts::injectVaultPrewarmBridge --> <!-- @test: src/__tests__/routes/vault-html-direct.test.ts (posts ready only after two consecutive complete polls and resets after incomplete evidence) -->
...
1. Successful bootstrap persists browser encryption completion before redirecting to the editor. <!-- @impl: src/lib/vault-view.ts::completeVaultBootstrap --> <!-- @test: src/__tests__/routes/vault-html-direct.test.ts (persists encryption completion before redirecting to the editor) -->
