...
4. Missing, superseded, inactive, or orphaned worker-scope evidence cannot satisfy local readiness. <!-- @impl: src/lib/vault-view.ts::checkVaultBridgeLocalReadiness --> <!-- @impl: web-ui/src/lib/vault-local-readiness.ts::checkVaultLocalReadiness --> <!-- @test: src/__tests__/routes/vault-html-direct.test.ts (binds the complete local-readiness decision to the exact current Vault scope) --> <!-- @test: web-ui/src/__tests__/lib/vault-local-readiness.test.ts (forces the unchanged prewarm lifecycle when legacy readiness has no recorded scope) -->
