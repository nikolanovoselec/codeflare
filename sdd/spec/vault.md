...
- The reload-skip is refused whenever the current container start is unknown (not yet polled) — an unverifiable container must never skip onto a possibly-resumed (stale) store; the effect re-runs and arms once the start polls in and matches.
