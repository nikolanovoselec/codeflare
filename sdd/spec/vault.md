...
4. Leaving the active view during in-flight prewarm cancels only the mounted iframe; returning to the still-running session remounts the iframe and resumes the preserved preparation intent. <!-- @impl: web-ui/src/components/Layout.tsx::Layout --> <!-- @impl: web-ui/src/components/Layout.tsx::clearPrewarmingVaultStatus --> <!-- @test: web-ui/src/__tests__/components/Layout.test.tsx (REQ-VAULT-018 AC4: dashboard departure cancels the in-flight iframe and return resumes preparation) -->
