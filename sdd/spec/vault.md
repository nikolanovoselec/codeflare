...
6. The first-click preparation path requests best-effort persistent browser storage. <!-- @impl: web-ui/src/components/Layout.tsx::requestVaultStoragePersistenceOnce --> <!-- @impl: web-ui/src/lib/browser-storage-persistence.ts::requestBrowserStoragePersistence --> <!-- @test: web-ui/src/__tests__/components/Layout.test.tsx (REQ-VAULT-012 AC6: first-click preparation requests persistent browser storage) --> <!-- @test: web-ui/src/__tests__/lib/browser-storage-persistence.test.ts (requestBrowserStoragePersistence) -->
7. Reduced-motion presentation keeps the Vault control's state colors without animation. <!-- @impl: web-ui/src/styles/header.css::prefers-reduced-motion --> <!-- @manual -->
...
3. A timeout or error stays visible without background retry; the next user click starts another bounded attempt. <!-- @impl: web-ui/src/components/Layout.tsx::Layout --> <!-- @test: web-ui/src/__tests__/components/Layout.test.tsx (retries a timed-out prewarm only after another user click) -->
...
4. The control shows available, accent preparation with focus warning, then green readiness with five-second confirmation; the second click opens instantly. <!-- @impl: web-ui/src/components/VaultButton.tsx::VaultButton --> <!-- @impl: web-ui/src/components/Layout.tsx::Layout --> <!-- @test: web-ui/src/__tests__/components/Layout.test.tsx (Layout Component / REQ-AUTH-014 (session expiry handling on 401)) -->
