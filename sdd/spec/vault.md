...
6. The control arms only when the two immediately preceding readiness checks are complete. <!-- @impl: src/lib/vault-view.ts::installVaultPrewarmBridgeRuntime --> <!-- @impl: src/lib/vault-view.ts::injectVaultPrewarmBridge --> <!-- @test: src/__tests__/routes/vault-html-direct.test.ts (posts ready only after two consecutive complete polls and resets after incomplete evidence) -->
