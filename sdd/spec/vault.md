...
<!-- @test: src/__tests__/lib/agent-seed-manifest.test.ts (Pi memory-vault shares Claude vault-extract.last marker semantics and vault-monitor exclusions → AC1/AC2/AC4) -->
