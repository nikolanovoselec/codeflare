...
5. A Pi-extension bump updates bracket-access version sentinels and preflights any exact-version Goal or Plan package transform before opening its PR. <!-- @impl: .github/workflows/bump-shadow-pins.yml::pi-extensions --> <!-- @test: src/__tests__/ci/suite-gates.test.ts (REQ-AGENT-155 AC7: Caveman participates in coherent Pi extension shadow bumps) --> <!-- @test: src/__tests__/ci/suite-gates.test.ts (REQ-AGENT-152: Plan Mode shadow bumps preflight the locked tool-policy patch) -->
