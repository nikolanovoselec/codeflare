...
5. The workflow runs a high-severity security audit on production dependency lockfiles; PRs introducing dependencies with known vulnerabilities are blocked. <!-- @impl: .github/workflows/test.yml::quality --> <!-- @test: src/__tests__/ci/suite-gates.test.ts (audits production lockfiles without depending on restored node_modules trees) --> <!-- @manual -->
