...
1. Every affected committed runtime lock resolves reviewed dependency security floors, including undici 8.9.0 in both Pi runtime trees, ip-address 10.3.1 or later in all three affected runtime trees, and fast-uri 3.1.6 or later in the Browser Run MCP, shared npm-tools, and Pi runtime locks. <!-- @impl: preseed/npm-tools/package-lock.json::node_modules/undici --> <!-- @impl: preseed/agents/pi/package-lock.json::node_modules/undici --> <!-- @impl: preseed/agents/claude/browser-run-mcp/package-lock.json::node_modules/ip-address --> <!-- @impl: preseed/agents/claude/browser-run-mcp/package-lock.json::node_modules/fast-uri --> <!-- @impl: preseed/npm-tools/package-lock.json::node_modules/fast-uri --> <!-- @impl: preseed/agents/pi/package-lock.json::node_modules/fast-uri --> <!-- @test: host/__tests__/dockerfile-dependency-integrity.test.js (pins patched versions across every affected committed runtime tree) -->
