...
6. Target validation rejects paths, credentials, IP or single-label hosts, control characters, queries, and fragments. <!-- @impl: scripts/ci/normalize-https-origin.mjs::raw --> <!-- @test: host/__tests__/normalize-https-origin.test.js (pentest target normalization) -->
...
3. Successful verification publishes reuse. <!-- @impl: scripts/ci/select-container-reuse.sh::PINNED_URI --> <!-- @test: host/__tests__/container-image-reuse-provenance.test.js (publishes reuse only when provenance verification succeeds) -->
...
5. Failed verification publishes no reuse. <!-- @impl: scripts/ci/select-container-reuse.sh::PINNED_URI --> <!-- @test: host/__tests__/container-image-reuse-provenance.test.js (publishes reuse only when provenance verification succeeds) -->
