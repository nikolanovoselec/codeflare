...
8. The built runtime image contains `libevent-core-2.1-7` at or above Debian's fixed `2.1.12-stable-8+deb12u1` version. <!-- @impl: Dockerfile::RUN apt-get update --> <!-- @impl: scripts/ci/smoke-openvscode-sidebar-image.mjs::verifyCodeServerRuntime --> <!-- @impl: .github/workflows/container-image.yml::Verify packaged native Pi Chat and official Claude --> <!-- @manual -->
