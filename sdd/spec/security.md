...
3. The deploy pipeline fails before push for an unexcepted fixable HIGH/CRITICAL vulnerability, a bounded-exception identity mismatch, or a runtime whose `libde265-0` or `libevent-core-2.1-7` version is below `1.0.11-1+deb12u3` or `2.1.12-stable-8+deb12u1`, respectively. <!-- @impl: .github/workflows/container-image.yml::image --> <!-- @impl: scripts/ci/validate-trivy-result.mjs::validateTrivyResult --> <!-- @impl: scripts/ci/smoke-openvscode-sidebar-image.mjs::verifyCodeServerRuntime --> <!-- @test: host/__tests__/trivy-exception-gate.test.js (Trivy bounded exception gate) --> <!-- @manual -->
