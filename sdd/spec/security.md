...
5. The container WebSocket forward is bounded by `CONTAINER_WS_FORWARD_TIMEOUT_MS`: a healthy container answers the upgrade in under a second. <!-- @impl: src/routes/terminal.ts::handleWebSocketUpgrade --> <!-- @impl: src/lib/constants.ts::CONTAINER_WS_FORWARD_TIMEOUT_MS --> <!-- @test: src/__tests__/routes/terminal-ws.test.ts (fast-fails with a 101 close (not an indefinite hang) when the container WS forward never answers) -->
