...
6. Working-agent steering is not reported complete without independent task evidence. <!-- @impl: preseed/agents/pi/skills/herdr/SKILL.md::Steer a working agent --> <!-- @test: host/__tests__/herdr-skill.test.js (REQ-AGENT-173: executes the documented Herdr orchestration flow) --> <!-- @manual: In Herdr, steer a working helper and confirm Pi does not report completion until the helper provides task-specific evidence. -->
7. Reading helper results does not disturb the terminal workspace. <!-- @impl: preseed/agents/pi/skills/herdr/SKILL.md::Read results --> <!-- @test: host/__tests__/herdr-skill.test.js (REQ-AGENT-173: executes the documented Herdr orchestration flow) --> <!-- @manual: In Herdr, read a helper's results and confirm the current focus and helper pane remain unchanged. -->
