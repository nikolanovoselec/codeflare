...
- The boundary extension reuses the stock widget's display structure and lifecycle for public service records; it adds no second agent extension or execution path.
