...
8. Every native reviewer retains its complete lane enforcement skill while its tool surface supports batched evidence gathering without serial context-search or file-processing tools. <!-- @impl: preseed/agents/pi/agents/code-reviewer.md --> <!-- @impl: preseed/agents/pi/agents/spec-reviewer.md --> <!-- @impl: preseed/agents/pi/agents/doc-updater.md --> <!-- @test: host/__tests__/pi-native-review-assets.test.js (REQ-AGENT-071: reviewers retain enforcement skills while using batched evidence tools) -->
