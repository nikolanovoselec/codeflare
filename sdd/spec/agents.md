...
7. The first authoritative candidate after session resume may recover one same-head launch and its deferred Goal pause. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::registerReviewEnforcement --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-036/REQ-AGENT-112: resumed sessions evaluate one new authoritative candidate and restore Goal pause) -->
