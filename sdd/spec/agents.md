...
- Explicit single-branch pushes never cross checkout boundaries; implicit push forms resolve eligibility from Git's configured push branch for the event repository's checked-out branch.
