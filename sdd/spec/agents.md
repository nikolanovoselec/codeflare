...
3. Reviewer service spawns are background work with inherited context disabled. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::dispatchReviewWindow --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-071/REQ-AGENT-080: spawns reviewers through the service before CI without a model launch turn) -->
