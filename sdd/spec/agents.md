...
6. Only a boundary plan emitted after an eligible push or protected-base PR creation authorizes reviewer launches; unpublished local commits do not. <!-- @impl: preseed/agents/pi/rules/engineering-constitution.md::Review and CI gates --> <!-- @impl: preseed/agents/pi/rules/git-workflow.md::No pre-push reviewers --> <!-- @test: host/__tests__/engineering-constitution.test.js (REQ-AGENT-080 AC6: authorizes reviewers only for an emitted post-boundary plan) -->
