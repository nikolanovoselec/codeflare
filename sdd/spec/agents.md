...
4. Claude's permanently loaded safe-check rule remains below 400 characters. <!-- @impl: preseed/agents/claude/rules/no-local-builds.md::Local execution gate --> <!-- @test: src/__tests__/lib/agent-seed-manifest.test.ts (REQ-AGENT-157 AC4: Claude permanently loaded policy stays below 400 characters) -->
