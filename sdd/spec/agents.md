...
- The Pi fix directive orders an automatic push after accepted fixes are complete; it never merges, creates a no-op commit, or pushes when no accepted file change exists. A successful fix push remains automatic review consent.
