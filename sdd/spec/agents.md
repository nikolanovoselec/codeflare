...
5. `/review-results` remains a manual fallback that displays the saved `summary.md` for the current exact head without mutating delivery state or relying on nonce/announcement records. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::review-results -->
