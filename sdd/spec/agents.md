...
8. Every Pi rule-transform key resolves to a rule present in the Claude source set; a key that does not fails generation. <!-- @impl: scripts/generate-agent-seed.mjs::generate --> <!-- @test: host/__tests__/pi-rule-transform-membership.test.js (generate-agent-seed.mjs - Pi rule-transform membership) -->
...
1. Claude `code-reviewer`, `spec-reviewer`, and `doc-updater` expose the scoped-evidence toolset: enforcement skills, direct shell execution, native file reads, and cross-session Graphify signal lookup. <!-- @impl: preseed/agents/claude/agents/code-reviewer.md::tools --> <!-- @impl: preseed/agents/claude/agents/spec-reviewer.md::tools --> <!-- @impl: preseed/agents/claude/agents/doc-updater.md::tools --> <!-- @test: src/__tests__/lib/agent-seed-manifest.test.ts (REQ-AGENT-086 AC7/AC8: Claude PR reviewers carry the packet transport and no repository-wide scan tools) -->
