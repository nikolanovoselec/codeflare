...
3. Until FIX, Pi reuses a persisted plan for the same repository, PR, and head while retaining its initiating boundary ID; FIX permits a newly authorized cycle. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::launchBoundaryPlan --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-132/REQ-AGENT-141: an automatic exact-head plan suppresses later ordinary-boundary consent) --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-132/REQ-AGENT-141: a user-approved exact-head plan suppresses later ordinary-boundary consent) --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-098/REQ-AGENT-126: a prior same-head FIX does not suppress a newly authorized cycle) -->
...
4. A visible exact-head plan stays authoritative across later ordinary activity until its FIX handoff. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::launchBoundaryPlan --> <!-- @impl: preseed/agents/pi/extensions/review-helpers.ts::reviewTranscriptFacts --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-132/REQ-AGENT-141: startup and resume keep an existing exact-head plan authoritative across later ordinary activity) --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-098/REQ-AGENT-126: a prior same-head FIX does not suppress a newly authorized cycle) -->
...
- Out-of-session pushes require a later supported root boundary; Pi creates no review event ledger.
- A merged unacknowledged head emits one visibility notice and never consumes bypass or writes acknowledgement. <!-- @impl: preseed/agents/pi/extensions/review-enforcement.ts::registerReviewEnforcement --> <!-- @test: src/__tests__/lib/review-enforcement.test.ts (REQ-AGENT-041/REQ-AGENT-058/REQ-AGENT-113/REQ-AGENT-114: a merged PR releases Goal without consuming bypass or acknowledging) -->
