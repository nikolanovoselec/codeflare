...
6. The 20-second no-output timeout safety net applies only to classic sessions. <!-- @impl: host/src/server.ts::server.listen --> <!-- @test: host/__tests__/terminal-mode.test.js (REQ-TERM-035 AC2: timeout and orphan expiry never report Herdr ready before bootstrap) -->
