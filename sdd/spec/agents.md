...
2. Standard and Advanced Pi route broad Codeflare capability or onboarding questions, tour requests, and numbered tutorial replies by directly reading `~/.pi/agent/skills/codeflare-capabilities/SKILL.md`, without calling tool-only capability discovery or substituting generic discovery. <!-- @impl: preseed/agents/pi/rules/codeflare-capabilities.md::Capability route --> <!-- @manual: Inspect the authoritative Pi rule and generated Standard and Advanced outputs. -->
