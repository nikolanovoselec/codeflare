...
3. First-time users are auto-redirected to onboarding. <!-- @impl: web-ui/src/App.tsx --> <!-- @test: web-ui/src/__tests__/components/auth-007-app-redirect.test.tsx (REQ-AUTH-007 AC5: a first-time active user is redirected to onboarding) -->
4. Once onboarding has been completed, the user is not redirected there again. <!-- @impl: web-ui/src/App.tsx --> <!-- @test: web-ui/src/__tests__/components/auth-007-app-redirect.test.tsx (REQ-AUTH-007 AC5: onboardingComplete gates the first-login onboarding redirect) -->
