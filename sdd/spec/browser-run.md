...
2. Claude's interactive browser connects to Cloudflare Browser Run's CDP `/devtools` surface. <!-- @impl: entrypoint.sh::CDP_WS_ENDPOINT --> <!-- @test: host/__tests__/entrypoint-browser-run-mcp.test.js (entrypoint Browser Run MCP wiring) -->
...
7. Claude's interactive browser uses the image-owned pinned server without runtime package resolution. <!-- @impl: entrypoint.sh::CDP_MCP_BIN --> <!-- @test: host/__tests__/entrypoint-browser-run-mcp.test.js (entrypoint Browser Run MCP wiring) -->
...
7. An idle Pi session does not retain the interactive browser bridge before first use or after the bridge becomes idle. <!-- @impl: entrypoint.sh::BROWSER_MCP_PI --> <!-- @test: host/__tests__/entrypoint-browser-run-mcp.test.js (entrypoint Browser Run MCP wiring) -->
