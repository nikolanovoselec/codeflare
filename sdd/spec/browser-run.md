...
2. Claude can interactively navigate and inspect rendered pages. <!-- @impl: entrypoint.sh::CDP_WS_ENDPOINT --> <!-- @test: host/__tests__/entrypoint-browser-run-mcp.test.js (entrypoint Browser Run MCP wiring) -->
...
7. Pi starts interactive browser resources on first use and releases them after inactivity. <!-- @impl: entrypoint.sh::BROWSER_MCP_PI --> <!-- @test: host/__tests__/entrypoint-browser-run-mcp.test.js (entrypoint Browser Run MCP wiring) -->
