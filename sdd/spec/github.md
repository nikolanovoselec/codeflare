...
1. Clone offers running sessions first and a separated new-session option; running rows use their session agent icon and subtitle. <!-- @impl: web-ui/src/components/github/ClonePickerOptionRow.tsx::ClonePickerOptionRow --> <!-- @test: web-ui/src/__tests__/components/ClonePicker.test.tsx (ClonePicker) -->
