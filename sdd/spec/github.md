...
5. The panel follows the adaptive Dashboard contract: narrow/mobile layouts show one flippable face at a time, while tablet/desktop layouts stack the GitHub and storage faces. <!-- @impl: web-ui/src/components/Dashboard.tsx::effectiveFace --> <!-- @test: web-ui/src/__tests__/components/Dashboard.test.tsx (Dashboard Component) -->
