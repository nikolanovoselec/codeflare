...
7. Overview Environment summaries link directly to their bounded editors without duplicating the sidebar's Environment navigation. <!-- @impl: web-ui/src/components/admin/AdministrationOverview.tsx::AdministrationOverview --> <!-- @test: web-ui/src/__tests__/components/AdministrationOverview.test.tsx (Administration overview Environment navigation) -->
