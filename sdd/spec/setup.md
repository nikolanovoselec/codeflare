...
5. Persisted managed-release diagnostics redact repository credentials. <!-- @impl: src/lib/remote-curation.ts::safeError --> <!-- @test: src/__tests__/lib/remote-curation.test.ts (REQ-SETUP-014 AC5 and REQ-AGENT-162 AC2: degraded diagnostics redact credentials and bound refresh retries) -->
