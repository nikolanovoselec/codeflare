...
1. The terminal viewport disables native scrolling on all devices so xterm's own scroll layer is the sole scroller. <!-- @impl: web-ui/src/hooks/useTerminal.ts::useTerminal --> <!-- @test: e2e/ui/mobile-specific.test.ts (REQ-MOB-004 AC1: terminal viewport leaves scrolling to xterm) -->
