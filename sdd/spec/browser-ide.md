...
9. GitHub Actions CI proves the pinned package and host contracts, including proposal admission, account-free model metadata, fail-closed provider generation, inventory isolation, and process lifecycle cleanup. <!-- @impl: scripts/ci/smoke-openvscode-sidebar-image.mjs::verifyPackagedNativeChat --> <!-- @test: scripts/ci/smoke-openvscode-sidebar-image.mjs::verifyPackagedNativeChat -->
