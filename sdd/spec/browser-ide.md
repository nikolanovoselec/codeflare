...
8. Panel Chat exposes editor selections as one-based human-readable coordinates. <!-- @impl: openvscode/agent-sidebar/src/pi/vscode-native-chat.ts::snapshotActiveEditor --> <!-- @test: openvscode/agent-sidebar/test/vscode-native-chat.test.ts (REQ-IDE-005 AC8 + REQ-IDE-006 AC1: native host collection captures one-based panel selection and rejects a symlink escape) -->
