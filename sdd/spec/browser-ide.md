...
7. The pinned OpenVSCode host registers the Codeflare view in its Activity Bar and resolves the generated webview document without weakening script authority. <!-- @impl: openvscode/agent-sidebar/src/package-extension.ts::stageSidebarExtension --> <!-- @impl: openvscode/agent-sidebar/src/extension.ts::activate --> <!-- @impl: openvscode/agent-sidebar/src/webview-security.ts::createWebviewDocument --> <!-- @test: openvscode/agent-sidebar/test/packaging.test.ts (REQ-IDE-005 AC7: contributes a host-compatible Codeflare Activity Bar view) --> <!-- @test: openvscode/agent-sidebar/test/webview-security.test.ts (REQ-IDE-005 AC7: webview accepts the pinned OpenVSCode CSP source without broadening script authority) -->
