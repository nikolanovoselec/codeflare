...
2. Before live activity starts, each terminal reveals its populated opening viewport from top to bottom: complete context on desktop and the largest fully fitting prefix in a synchronized mobile/tablet frame; throughout the following hold, a continuously blinking caret rests on the final opening row without adding another row. <!-- @impl: landing/src/scripts/proof.ts::prepareFeed --> <!-- @impl: landing/src/scripts/proof.ts::startFeed --> <!-- @impl: landing/src/styles/global.css::t-caret --> <!-- @impl: landing/src/styles/global.css::term-type --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (prepares populated opening rows and retains complete context histories) --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (matches the Hero frame and queues fractionally clipped context without visible resets) --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (types the simulation to completion in a fixed scrolling log with final cursor) -->
...
5. At mobile and tablet widths, normal motion reveals the largest approved context prefix whose final row fits fully inside the synchronized frame. <!-- @impl: landing/src/scripts/proof.ts::prepareFeed --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (matches the Hero frame and queues fractionally clipped context without visible resets) --> <!-- @manual -->
