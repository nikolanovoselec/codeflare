...
2. The two Execution terminal frames retain equal outer heights at every supported desktop, tablet, and mobile width. <!-- @impl: landing/src/scripts/proof.ts::syncExecutionFrames --> <!-- @impl: landing/src/styles/global.css::execution-terminal --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (matches the Hero frame and types context that cannot fit instead of hiding it) --> <!-- @manual -->
...
5. At tablet widths, both Execution terminal frames retain the same outer height as the rendered Hero terminal reel. <!-- @impl: landing/src/scripts/proof.ts::syncExecutionFrames --> <!-- @impl: landing/src/styles/global.css::execution-terminal --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (matches the Hero frame and types context that cannot fit instead of hiding it) --> <!-- @manual -->
6. At mobile and tablet widths, normal motion reveals the largest approved context prefix that fully fits the synchronized frame and types every remaining context row in order, so the first event never skips hidden pre-event history. <!-- @impl: landing/src/scripts/proof.ts::prepareFeed --> <!-- @impl: landing/src/scripts/proof.ts::startFeed --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (matches the Hero frame and types context that cannot fit instead of hiding it) --> <!-- @manual -->
