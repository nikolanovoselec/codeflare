...
3. Across the initial and every rolling eight-row viewport, meaningful transcript content fills both side-by-side terminal bodies without leaving more than one rendered line of trailing void. <!-- @impl: landing/src/content/site.ts::EXECUTION --> <!-- @test: landing/src/__tests__/index-page.test.ts (balances meaningful transcript content across every side-by-side viewport) --> <!-- @manual -->
