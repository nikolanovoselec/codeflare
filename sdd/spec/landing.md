...
3. Across the initial and every rolling eight-row viewport, meaningful transcript content fills both side-by-side terminal bodies without leaving more than one rendered line of trailing void. <!-- @impl: landing/src/content/site.ts::EXECUTION --> <!-- @manual -->
