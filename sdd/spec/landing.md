...
4. Throughout the hold before the first append, one continuously blinking layout-neutral caret rests on the final opening row without adding a row or advancing history. <!-- @impl: landing/src/scripts/proof.ts::placeFeedCaret --> <!-- @impl: landing/src/scripts/proof.ts::startFeed --> <!-- @impl: landing/src/styles/global.css::t-caret--waiting --> <!-- @test: landing/src/__tests__/execution-reel.script.test.ts (types the simulation to completion in a fixed scrolling log with final cursor) -->
