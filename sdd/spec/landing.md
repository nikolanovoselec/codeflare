...
3. The integrated terminal's command line is driven by the shared typed reel and nothing new: the `.code-editor` frame carries `data-ft-loop` (the content-model activity stream) plus `data-ft-shuffle`, and exactly one `[data-ft-typed]` line rests on the first beat. <!-- @impl: landing/src/components/CodeEditor.astro --> <!-- @impl: landing/src/content/site.ts --> <!-- @impl: landing/src/scripts/feature-terminals.ts --> <!-- @test: landing/src/__tests__/code-editor.test.ts (wires the integrated terminal to the shared reel: data-ft-loop + data-ft-shuffle on the frame, one data-ft-typed line resting on the first beat) --> <!-- @test: landing/src/__tests__/index-page.test.ts (drives the integrated terminal on the shared reel) -->
