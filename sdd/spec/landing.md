...
<!-- @test: landing/src/__tests__/index-page.test.ts (REQ-LANDING-001 describe -> AC4 sections/nav/terminal/stats/form render) -->
...
4. The landing renders the full enterprise narrative: hero with terminal demo transcript, all pillar sections with anchor ids matching the nav links, stats strip, FAQ, and the contact form.
