...
3. Reconciliation queues document bodies only from the current 16 KiB parser slice and admits at most six callbacks concurrently. <!-- @impl: src/lib/remote-curation.ts::streamManagedReleaseDocuments --> <!-- @test: src/__tests__/lib/remote-curation.test.ts (REQ-AGENT-151 AC4: applies backpressure after six pending document callbacks) -->
