...
5. A successful Enterprise Integration deploy invokes the stateless Gate 1 fixture; other targets do not, and repository and environment credentials retain their existing scopes. <!-- @impl: .github/workflows/deploy.yml::operator-gate1-fixture --> <!-- @impl: .github/workflows/deploy-operator-gate1.yml::deploy --> <!-- @test: host/__tests__/deploy-requires-tests.test.js (manual deploys cannot skip tests) -->
