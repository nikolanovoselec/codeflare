...
<!-- @test: web-ui/src/__tests__/components/Dashboard.test.tsx (enterprise user menu -> avatar visible but clicking opens no dropdown in enterprise AC2/AC8/AC9, in Dashboard menu) -->
