...
- The account-scoped exemption covers Codeflare control-plane traffic and closes cross-account exfiltration without routing high-volume, bootstrap-critical R2 sync through shared Gateway limits.
