...
6. An unverified target shows an orange Not ready status and is unavailable to access policies; a currently verified or administrator-confirmed target shows a green Ready status and is available. <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields --> <!-- @test: web-ui/src/__tests__/components/AiRoutingFields.test.tsx (REQ-ENTERPRISE-051: derives orange and green native readiness without an enable control) -->
...
6. Current verification or administrator confirmation makes the target ready and sets its draft enabled state automatically. <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields --> <!-- @test: web-ui/src/__tests__/components/AiRoutingFields.test.tsx (REQ-ENTERPRISE-051: derives orange and green native readiness without an enable control) --> <!-- @test: web-ui/src/__tests__/components/AiRoutingFields.test.tsx (REQ-ENTERPRISE-054: verification automatically enables the native target draft) -->
