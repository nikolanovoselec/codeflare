...
6. Current verification or administrator confirmation makes the target ready and sets its draft enabled state automatically; invalidating proof makes it not ready and disabled. <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields --> <!-- @test: web-ui/src/__tests__/components/AiRoutingFields.test.tsx (REQ-ENTERPRISE-054: verification automatically enables the native target draft) -->
