...
2. Settings exposes one "Open Administration" entry and no duplicate "Manage Users" action in every mode. <!-- @impl: web-ui/src/components/SettingsPanel.tsx::SettingsPanel --> <!-- @test: web-ui/src/__tests__/components/enterprise-surface-suppression.test.tsx (REQ-ENTERPRISE-008 AC1-AC3: SettingsPanel and session mode) -->
