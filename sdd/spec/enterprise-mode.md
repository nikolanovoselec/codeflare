...
2. Settings exposes one "Open Administration" entry and no duplicate "Manage Users" action in every mode; the Administration Users route remains limited to Default, Onboarding, and SaaS by [REQ-SETUP-019](setup.md#req-setup-019-administration-and-analytics-shell) AC2. <!-- @impl: web-ui/src/components/SettingsPanel.tsx::SettingsPanel --> <!-- @test: web-ui/src/__tests__/components/enterprise-surface-suppression.test.tsx (REQ-ENTERPRISE-008 AC1-AC3: SettingsPanel and session mode) -->
