...
2. Save remains unavailable while the draft contains an invalid provider or model identifier, an invalid context window, or an unavailable profile reference. <!-- @impl: src/lib/native-ai-target-draft.ts::nativeTargetDraftSchema --> <!-- @impl: web-ui/src/components/admin/AiRoutingFields.tsx::AiRoutingFields --> <!-- @test: web-ui/src/__tests__/components/AiRoutingFields.test.tsx (REQ-ENTERPRISE-066: enables Save for a complete disabled native draft without access policies) -->
