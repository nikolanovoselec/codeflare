...
<!-- @test: web-ui/src/__tests__/components/Header.test.tsx (Guided Setup gating (enterprise) describe -> AC8 Header menu) -->
<!-- @test: web-ui/src/__tests__/components/Dashboard.test.tsx (Enterprise: Guided Setup gating -> AC8 Dashboard menu) -->
