...
6. Naming adds an immutable custom revision to the configuration draft without assignment or activation. <!-- @impl: web-ui/src/components/admin/ReasoningProfileEditor.tsx::ReasoningProfileEditor --> <!-- @test: web-ui/src/__tests__/components/ReasoningProfileEditor.test.tsx (creates a named immutable revision from the discovered mapping without assigning or activating it) -->
