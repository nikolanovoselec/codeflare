...
- Compaction changes storage shape and provenance only.
- Semantic pruning, summarization, node deletion, edge deletion, and relevance-based retention remain out of scope.
