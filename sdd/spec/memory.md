...
5. Capture input is bounded by a fixed character budget, spent newest-first on user prompts before assistant turns, with each turn individually capped. <!-- @impl: preseed/agents/pi/extensions/memory-vault-helpers.ts::selectTurns --> <!-- @impl: preseed/agents/pi/extensions/memory-vault-helpers.ts::capTurn --> <!-- @test: src/__tests__/lib/agent-seed-pi-memory.test.ts (REQ-MEM-001: compactMessages prefilter (AD58)) -->
