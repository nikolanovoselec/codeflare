...
6. A session whose monitor loses container transport attempts bounded recovery before exit confirmation. <!-- @impl: src/container/container-lifecycle.ts::onError --> <!-- @impl: src/container/container-metrics.ts::beginMonitorTransportRecovery --> <!-- @test: src/__tests__/container-metrics.test.ts (REQ-SESSION-021 AC6: reconstructs immediately when the SDK monitor loses container services after running becomes false) -->
7. When bounded recovery cannot be armed and its partial incident is cleared, ordinary exit confirmation remains armed. <!-- @impl: src/container/container-lifecycle.ts::onError --> <!-- @impl: src/container/container-metrics.ts::beginMonitorTransportRecovery --> <!-- @test: src/__tests__/container-metrics.test.ts (failed monitor-recovery scheduling retains ordinary exit confirmation) -->
