...
4. When a session remains active but its terminal cannot be forwarded without waking the container, the WebSocket receives retryable 1013. <!-- @impl: src/container/index.ts::fetch --> <!-- @test: src/__tests__/container/index.test.ts (REQ-SESSION-012 AC4: returns retryable 1013 when volatile runtime state reads not-running) -->
