...
- The container must not signal readiness (outer PTY, Herdr client, and configured bootstrap complete) until initial sync succeeds, reaches its own timeout, or the host's 130-second degraded-start bound expires.
