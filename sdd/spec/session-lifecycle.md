...
1. The idle timeout is user-configurable with allowed values: 15m, 30m, 1h, 2h, 4h. <!-- @impl: src/container/container-metrics.ts::collectMetrics --> <!-- @impl: src/container/index.ts --> <!-- @test: src/__tests__/routes/session-sleep-timeout.test.ts (SleepAfterOptions exactly [15m,30m,1h,2h,4h]) --> <!-- @test: src/__tests__/container-metrics.test.ts (sleepAfter enforcement across allowed values incl. 4h) -->
