...
4. A transient inability to forward a terminal WebSocket signals retryable 1013 without waking the container. <!-- @impl: src/container/index.ts::fetch --> <!-- @test: src/__tests__/container/index.test.ts (REQ-SESSION-012 AC4: returns retryable 1013 when volatile runtime state reads not-running) -->
