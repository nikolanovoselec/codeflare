...
6. Enforcement is best effort: the KV list/count and later `running` write are not atomic, so simultaneous starts may both pass and exceed the nominal limit until a session stops.
