...
6. A pane that loses focus before its terminal connection opens does not claim resize authority when that connection later opens. <!-- @impl: web-ui/src/hooks/useTerminal.ts::useTerminal --> <!-- @impl: web-ui/src/stores/terminal.ts::clearPendingResizeAuthority --> <!-- @test: web-ui/src/__tests__/stores/terminal.test.ts (stale queued focus clearing) --> <!-- @test: web-ui/src/__tests__/hooks/useTerminal.test.ts (queued focus clearing) -->
