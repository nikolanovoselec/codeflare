...
4. Opening a ready terminal session immediately restarts any visible pane whose startup socket is disconnected or still connecting behind the readiness overlay, without replacing a healthy connection. <!-- @impl: web-ui/src/components/Layout.tsx::handleOpenSessionById --> <!-- @impl: web-ui/src/stores/terminal.ts::reconnectOnVisibilityReturn --> <!-- @test: web-ui/src/__tests__/components/Layout.test.tsx (REQ-TERM-043 AC4: OPEN restarts a visible terminal stuck connecting behind the ready overlay) --> <!-- @test: web-ui/src/__tests__/stores/terminal.test.ts (REQ-TERM-043 AC4: restarts only visible connecting panes when OPEN dismisses readiness) -->
