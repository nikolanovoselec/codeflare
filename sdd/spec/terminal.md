...
7. One vertical touch swipe sends one PageUp or PageDown input to Herdr. <!-- @impl: web-ui/src/lib/touch-gestures.ts::attachSwipeGestures --> <!-- @test: web-ui/src/__tests__/lib/touch-gestures.test.ts (REQ-MOB-017 AC1-AC2: routes one Herdr swipe through stable page navigation) -->
