...
3. The shell init reads the per-tab configuration and launches the configured agent (Claude Code, Codex, Antigravity, OpenCode, or Copilot CLI), each in non-interactive sandboxed mode appropriate for its CLI.
