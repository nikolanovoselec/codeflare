...
- History uses existing D1 period rows without synthetic points, a second aggregate table, or a cache.
- Weeks start Monday at 00:00 UTC; they are not relabelled as local-time aggregates.
