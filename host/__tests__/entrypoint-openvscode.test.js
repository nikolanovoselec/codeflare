...
describe('complete_managed_curation_startup / REQ-IDE-048 AC4/AC5 (workspace launch)', () => {
...
describe('_openvscode_should_launch / REQ-IDE-003 AC1 + REQ-IDE-048 AC4/AC5 (workspace launch gate)', () => {
...
describe('_openvscode_launch_once / REQ-IDE-001, REQ-IDE-002 (session-isolated code-server launch command)', () => {
  ...
  it('REQ-IDE-017 AC2: seeds immutable base extensions into a writable session layer', () => {
