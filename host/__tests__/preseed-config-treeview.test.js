// REQ-VAULT-008 AC5: preseed CONFIG.md declares treeview exclusions
...
test('CONFIG.md has a treeview.exclusions block with the upstream schema (REQ-VAULT-008 AC5)', () => {
...
test('treeview rules hide every entry that should be hidden (REQ-VAULT-008 AC5)', () => {
...
test('treeview rules do NOT hide entries the user should see (REQ-VAULT-008 AC5)', () => {
  const rules = extractTreeviewRegexRules(loadSpaceLuaBlock());
