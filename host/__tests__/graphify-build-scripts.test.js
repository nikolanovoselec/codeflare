...
describe('Graphify build preseed', () => {
  ...
  it('REQ-AGENT-023 AC7: Claude and Pi semantic extraction scope cache writes to dispatched files', () => {
    for (const testCase of [
      {
        path: 'preseed/agents/claude/skills/graphify/references/extraction-spec.md',
        heading: '**Step B3 - Collect, cache, and merge**',
        chunkDir: '.',
      },
      {
        path: 'preseed/agents/pi/skills/graphify/references/build.md',
        heading: '## Step 3 — merge chunks into Graphify semantic cache and local fragment',
        chunkDir: 'graphify-out',
      },
    ]) {
