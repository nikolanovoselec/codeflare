...
describe('Container Status Routes', () => {
  ...
  describe('GET /container/startup-status', () => {
    ...
    it('REQ-IDE-048 AC4: keeps a VS Code session mounting until editor readiness', async () => {
      const app = createStatusApp();
    ...
    it('REQ-IDE-048 AC4: reports VS Code ready and mirrors readiness into session metadata', async () => {
      const app = createStatusApp();
      mockKV._set('session:test-bucket:abcdef1234567890abcdef12', {
        id: 'abcdef1234567890abcdef12', name: 'Editor', userId: 'test-bucket',
    ...
    it('REQ-IDE-048 AC4: preserves concurrent session fields when persisting readiness', async () => {
      const app = createStatusApp();
    ...
    it('REQ-IDE-048 AC4: does not recreate a session deleted while readiness resolves', async () => {
      const app = createStatusApp();
      const key = 'session:test-bucket:abcdef1234567890abcdef12';
      mockKV._set(key, {
        id: 'abcdef1234567890abcdef12', name: 'Editor', userId: 'test-bucket',
    ...
    it('REQ-IDE-048 AC4: surfaces bounded editor warm-up failure with retry guidance', async () => {
      const app = createStatusApp();
      mockKV._set('session:test-bucket:abcdef1234567890abcdef12', {
        id: 'abcdef1234567890abcdef12', name: 'Editor', userId: 'test-bucket',
        workspace: 'vscode', createdAt: new Date().toISOString(), lastAccessedAt: new Date().toISOString(),
    ...
    it('REQ-IDE-048 AC4: a successful retry clears the persisted readiness error', async () => {
      const app = createStatusApp();
      mockKV._set('session:test-bucket:abcdef1234567890abcdef12', {
        id: 'abcdef1234567890abcdef12', name: 'Editor', userId: 'test-bucket',
        workspace: 'vscode', editorReady: false,
