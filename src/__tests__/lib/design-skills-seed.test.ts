...
describe('REQ-AGENT-134: advanced design skill suite', () => {
  it('delivers the master router and three specialists to every skill-capable agent', () => {
  ...
  it('keeps the master as routing policy instead of duplicating specialist bodies', () => {
  ...
  it('ships upstream licenses and marks the adapted Canvas file', () => {
  ...
  it('uses an independently authored Codeflare frontend skill', () => {
  ...
  it('rewrites UI UX Pro Max search paths for each generated runtime', () => {
