...
import type { OperatorDispatcherLoaderBinding, OperatorLoaderBinding } from './operators/loader';
import { z } from 'zod';
...
export const SleepAfterOptions: SleepAfterOption[] = ['15m', '30m', '1h', '2h', '4h'];
