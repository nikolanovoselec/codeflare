...
- **MultiView** — view several running sessions side by side in one workspace, each pane its own agent and container. It's a virtual view over sessions you already have, so no new container is started.
