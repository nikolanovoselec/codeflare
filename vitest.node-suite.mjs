...
export const NODE_SUITE_FILES = [
  ...
  // pi-memory-inject and pi-post-compaction-recall both drive real temp trees
  // through node:fs, and the first stands in a working directory to prove no
  // repo graph is substituted - neither is available under the Workers pool.
