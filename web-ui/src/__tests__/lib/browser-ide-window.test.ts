...
describe('browser IDE window ownership', () => {
  it('opens every explicit gesture synchronously with the same-origin URL and stable session target', () => {
  ...
  it('focuses a live retained handle without navigation or a second open', () => {
  ...
  it('uses independent named targets and retained handles for different sessions', () => {
  ...
  it('reports a null window.open result as popup blocked', () => {
