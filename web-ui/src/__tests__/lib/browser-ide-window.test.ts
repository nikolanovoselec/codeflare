...
describe('browser IDE window ownership', () => {
  it('REQ-IDE-055 AC1: opens every explicit gesture synchronously', () => {
  ...
  it('REQ-IDE-055 AC1: focuses a live retained handle without navigation or a second open', () => {
  ...
  it('REQ-IDE-055 AC1: uses independent named targets and retained handles for different sessions', () => {
  ...
  it('REQ-IDE-055 AC2: reports a null window.open result as popup blocked', () => {
