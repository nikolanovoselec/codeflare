...
describe('browser IDE window ownership', () => {
  it('REQ-IDE-054 AC6: opens every explicit gesture synchronously', () => {
  ...
  it('REQ-IDE-054 AC6: focuses a live retained handle without navigation or a second open', () => {
  ...
  it('REQ-IDE-054 AC6: uses independent named targets and retained handles for different sessions', () => {
  ...
  it('REQ-IDE-054 AC7: reports a null window.open result as popup blocked', () => {
